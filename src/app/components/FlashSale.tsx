    ...
    <section className="bg-white p-6 rounded-lg shadow-md my-8">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center space-x-2 text-2xl font-bold">
          <span className="bg-red-600 text-white px-3 py-2 rounded">{String(timeLeft.hours).padStart(2, '0')}</span>:
          <span className="bg-red-600 text-white px-3 py-2 rounded">{String(timeLeft.minutes).padStart(2, '0')}</span>:
          <span className="bg-red-600 text-white px-3 py-2 rounded">{String(timeLeft.seconds).padStart(2, '0')}</span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {flashSaleProducts.map((product) => (
          <div key={product.id} className="bg-white p-4 rounded-lg text-center flex flex-col min-h-[300px]">
